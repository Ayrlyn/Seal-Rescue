...
public class Nursery : Building
{
	...
	public List<Seal> ResidentSeals
	{
		get
		{
			...
			{
				if ((int)seal.RescueProgress >= 40 && (int)seal.RescueProgress <= 80) { residentSeals.Add(seal); }
			}
    ...
    public override void ReceiveEmployee(EmployeeIconPrefab employeeIconPrefab)
    {
        ...
        employeeIconPrefab.Employee.Location = "Nursery";
    }
    #endregion
